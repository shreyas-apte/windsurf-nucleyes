          ...
          <div className="grid gap-12 lg:gap-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="order-2">
                ...
                <p className="text-gray-600 mb-6">
                  Our experienced consultants provide strategic guidance to help businesses align their technology investments with their business objectives. We will help you navigate complex technology landscapes and make informed decisions.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <svg className="h-6 w-6 text-blue-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
