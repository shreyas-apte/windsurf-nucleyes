          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Have questions about our services or want to discuss a potential project? Fill out the form below and one of our experts will get back to you shortly.
              </p>
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center px-6 py-3 border border-blue-600 text-base font-medium rounded-md text-blue-600 bg-white hover:bg-blue-50 transition-colors w-full sm:w-auto"
                  >
                    Send Message
                  </button>
                </div>
            ...
            <div>
              <div className="bg-gray-50 p-8 rounded-lg border border-gray-100 shadow-sm h-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">
                        info@nucleyes.com<br />
                        support@nucleyes.com
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="#" className="w-10 h-10 bg-blue-50 text-blue-400 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                      </svg>
                    </a>
                    <a href="#" className="w-10 h-10 bg-indigo-50 text-indigo-600 rounded-full flex items-center justify-center hover:bg-indigo-100 transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                      </svg>
                    </a>
                    <a href="#" className="w-10 h-10 bg-red-50 text-red-500 rounded-full flex items-center justify-center hover:bg-red-100 transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative h-96 rounded-lg overflow-hidden shadow-md">
            ...
            <div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500 mt-2">123 Innovation Street, Tech City, TC 12345</p>
              </div>
            </div>
          </div>
        </div>
